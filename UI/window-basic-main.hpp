...
private:
	...
	std::unique_ptr<BasicOutputHandler> hxFlvOutputHandler; //liuzhi
	...
	QPointer<QAction>         sysTrayHxFlvStream; //liuzhi
...
public slots:
	...
	//////////////////////////////////////////////////////////////////
	//liuzhi
	void HxFlvStartStreaming(); //启动
	void HxFlvStopStreaming(); //停止
	void HxFlvStreamStopping(); //正在停止时
	void HxFlvStreamingStart();	//成功启动后
	void HxFlvStreamingStop(int code, QString last_error); //停止后
	void HxFlvStreamDelayStarting(int sec);
	void HxFlvStreamDelayStopping(int sec);
	////////////////////////////////////////////////////////////////
...
private slots:
	...
	void on_hxFlvstreamButton_clicked(); //liuzhi
